...
SQL = ["select count(*), max(to_date('1970-01-01','YYYY-MM-DD') + numtodsinterval(created_t,'SECOND')), min(to_date('1970-01-01','YYYY-MM-DD') + numtodsinterval(created_t,'SECOND')) from PIN.EVENT_T where (to_date('1970-01-01','YYYY-MM-DD') + numtodsinterval(created_t,'SECOND')) <= to_date('2017-04-16  17:00:00','YYYY-MM-DD HH24:MI:SS')"]
